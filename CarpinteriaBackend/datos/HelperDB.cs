...
namespace CarpinteriaBackend.datos
{
    public class HelperDB
    {
        ...
        private HelperDB()
        {
            cnn = new SqlConnection("Data Source=DESKTOP-THFRT3G\\SQLEXPRESS;Initial Catalog=db_carpinteria;Integrated Security=True;Encrypt=False");
        }
